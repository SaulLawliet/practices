...
#|
(magnitude (make-complex-from-real-image 3 4))
...
;; Testing
(= 5 (magnitude (make-complex-from-real-imag 3 4)))
...
;; Testing
(= 3 (add (make-scheme-number 1) (make-scheme-number 2)))
...
(not (equ? (make-scheme-number 1) (make-scheme-number 2)))
;; rational
(equ? (make-rational 1 2) (make-rational 2 4))
(not (equ? (make-rational 1 2) (make-rational 2 5)))
;; complex
(equ? (make-complex-from-real-imag 3 4) (make-complex-from-real-imag 3 4))
(not (equ? (make-complex-from-real-imag 3 4) (make-complex-from-real-imag 4 3)))
(equ? (make-complex-from-mag-ang 5 0.45) (make-complex-from-mag-ang 5 0.45))
(not (equ? (make-complex-from-mag-ang 5 0.45) (make-complex-from-mag-ang 5 0.60)))
...
(not (=zero? (make-complex-from-real-imag 1 0)))
